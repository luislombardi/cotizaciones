...
volatilidad_bp = Blueprint('volatilidad', __name__)
...
@volatilidad_bp.route('/volatilidad')
def mostrar_volatilidad():
    ...
    tabla_html = df_tabla.to_html(classes='table table-striped')

    return render_template('volatilidad.html', tabla_html=tabla_html)